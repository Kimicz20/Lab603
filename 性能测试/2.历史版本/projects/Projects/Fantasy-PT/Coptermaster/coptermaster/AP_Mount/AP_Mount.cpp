    ...
    _primary(0)
{
	...
	state[0]._default_mode = MAV_MOUNT_MODE_RC_TARGETING;
	//state[0]._retract_angles=0;
	//state[0]._neutral_angles = 0;
	state[0]._stab_roll = 0;
	state[0]._stab_tilt = 0;
	state[0]._stab_pan = 0;
		state[0]._roll_rc_in = 0;
		state[0]._roll_angle_min = -4500;
		state[0]._roll_angle_max = 4500;
		state[0]._tilt_rc_in = 0;
		state[0]._tilt_angle_min = -4500;
		state[0]._tilt_angle_max = 4500;
		state[0]._pan_rc_in = 0;
		state[0]._pan_angle_min = -4500;
		state[0]._pan_angle_max = 4500;
		_joystick_speed = 0;
		state[0]._roll_stb_lead = 0.0f;
		state[0]._pitch_stb_lead = 0.0f;
		state[0]._type = 0;
		//state[0]._gimbalParams.joint_angles_offsets = 0;
		//state[0]._gimbalParams.delta_velocity_offsets = 0;
		//state[0]._gimbalParams.delta_angles_offsets = 0;
		state[0]._gimbalParams.K_gimbalRate = 5.0f;

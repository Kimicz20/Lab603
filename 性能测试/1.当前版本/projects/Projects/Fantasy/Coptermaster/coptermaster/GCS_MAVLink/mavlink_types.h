...
// Macro to define  structures
#ifdef __GNUC__
  #define MAV( __Declaration__ ) __Declaration__ __attribute__(())
#else
  #define MAV( __Declaration__ ) __pragma( pack(push, 1) ) __Declaration__ __pragma( pack(pop) )
#endif

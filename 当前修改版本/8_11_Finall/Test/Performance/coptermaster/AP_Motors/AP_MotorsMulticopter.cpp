...
void AP_MotorsMulticopter::output()
{
	...
	_flags.armed = supt->getParamValueWithNameAndKey("output_armed_not_stabilizing","_flags.armed"); 
	_flags.interlock = supt->getParamValueWithNameAndKey("output_armed_not_stabilizing", "_flags.interlock");
	_flags.stabilizing = supt->getParamValueWithNameAndKey("output_armed_not_stabilizing", "_flags.stabilizing");
	if (_flags.armed == 1) {

...
{
	cout << "------ compass_accumulate begin -----" << endl;
	long start, end;
	...
	cout << "------ compass_accumulate end -----" << endl;
}
...
{
	cout << "------ barometer_accumulate begin -----" << endl;
	barometer.accumulate();
	cout << "------ barometer_accumulate end -----" << endl;
}
...
void Copter::loop()
{
	...
	// ------------------------  ²å×®µã ---------------------------------
	start = clock();
	supt->setCurProcessResult("wait_for_sample", start, 1);
	// ------------------------  ²å×®¼¤Àø --------------------------------- 
	ins.supt = supt;
	ins.wait_for_sample();
	end = clock();
	supt->setCurProcessResult("wait_for_sample", end, 2);
	supt->setCurProcessResult("wait_for_sample", (end - start), 3);
...
{
	cout << "------ update_batt_compass begin -----" << endl;
	...
	cout << "------ update_batt_compass end -----" << endl;
}
...
void Copter::three_hz_loop()
{
	...
	cout << "------ three_hz_loop end -----" << endl;
}

// one_hz_loop - runs at 1Hz
void Copter::one_hz_loop()
{
	cout << "------ one_hz_loop begin -----" << endl;
	/*if (should_log(MASK_LOG_ANY)) {
	...
	cout << "------ one_hz_loop end -----" << endl;
}

// called at 50hz
void Copter::update_GPS(void)
{
	cout << "------ update_GPS begin -----" << endl;

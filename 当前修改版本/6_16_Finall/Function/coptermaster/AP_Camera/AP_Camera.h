...
public:
        ...
        _image_index(0)
    {
		...
		//_trigger_type = AP_CAMERA_TRIGGER_DEFAULT_TRIGGER_TYPE;
		//_trigger_duration = AP_CAMERA_TRIGGER_DEFAULT_DURATION;
		//_servo_on_pwm = AP_CAMERA_SERVO_ON_PWM;
		//_servo_off_pwm = AP_CAMERA_SERVO_OFF_PWM;
		//_trigg_dist = 0;
		//_relay_on = 1;

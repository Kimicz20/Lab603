 ...
 *      
 ic for individual flight modes is in control_acro.pde, control_stabilize.pde, etc
 */
...
void Copter::update_flight_mode()
{
	...
	cout << "set fly mode£º1 GUIDED 2 CIRCLE 3 LAND" << endl;
    int a = 0;
    
	string filed[] = {"5","stabilize_run","guided_takeoff_run","land_run","circle_run","rtl_run"};
	a = supt->getParamValueFormNamesWithKey(filed , "control_mode");

    ...
    _speed_under_min_time(0)
{
	...
	_enabled = 0;
	_pump_pct_1ms = AC_SPRAYER_DEFAULT_PUMP_RATE;
	_spinner_pwm = AC_SPRAYER_DEFAULT_SPINNER_PWM;
	_speed_min = AC_SPRAYER_DEFAULT_SPEED_MIN;
	_pump_min_pct = AC_SPRAYER_DEFAULT_PUMP_MIN;

...
AP_SerialManager::AP_SerialManager()
{
	...
	state[0].baud = AP_SERIALMANAGER_CONSOLE_BAUD / 1000;
	state[1].protocol = SerialProtocol_MAVLink;
	state[1].baud = AP_SERIALMANAGER_MAVLINK_BAUD / 1000;
	state[2].protocol = SerialProtocol_MAVLink;
	state[2].baud = AP_SERIALMANAGER_MAVLINK_BAUD / 1000;
	state[3].protocol = SerialProtocol_GPS;
	state[3].baud = AP_SERIALMANAGER_GPS_BAUD / 1000;
	state[4].protocol = SerialProtocol_GPS;
	state[4].baud = AP_SERIALMANAGER_GPS_BAUD / 1000;
}

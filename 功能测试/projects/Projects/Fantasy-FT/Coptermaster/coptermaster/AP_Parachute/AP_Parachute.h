...
public:
        ...
        _released(false)
    {
		...
		_enabled = 0;
		_release_type= AP_PARACHUTE_TRIGGER_TYPE_RELAY_0;
		_servo_on_pwm= AP_PARACHUTE_SERVO_ON_PWM_DEFAULT;
		_servo_off_pwm= AP_PARACHUTE_SERVO_OFF_PWM_DEFAULT;
		_alt_min = AP_PARACHUTE_ALT_MIN_DEFAULT;
    }
